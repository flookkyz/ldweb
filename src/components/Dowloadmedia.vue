<template>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a
                class="nav-link active mx-2 text-dark"
                aria-current="page"
                href="/dowloadprogram"
                >ดาวน์โหลดโปรแกรม</a
              >
            ...
            <li class="nav-item">
              <a class="nav-link active mx-2 text-dark" href="/dowloadlicense"
                >ดาวน์โหลดLicense</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link active mx-2 text-dark" href="/dowloadmanual"
                >ดาวน์โหลดคู่มือ</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link active mx-2 text-dark" href="/video"
                >วิดิโอการใช้งาน</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link active mx-2 text-dark" href="/dowloadmedia"
                >ดาวน์โหลดสื่อการเรียนการสอน</a
              >
            </li>
          </ul>
        </div>
  ...
  <div class="my-4">
    <div class="col-md-9 offset-md-2">
      <h4>เลือกสื่อประกอบการจัดกิจกรรมค่ายพัฒนาศักยภาพเด็กนักเรียนแอลดีที่ต้องการ</h4>
    </div>
  </div>
